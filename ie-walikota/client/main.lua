...
AddEventHandler('wr-walikota:publicTeleports', function(position)
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('wr-walikota:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
            ...
            ESX.TriggerServerCallback('esx_service:enableService', function(canTakeService, maxInService, inServiceCount)
              ...
              if canTakeService then
                ...
                exports.pNotify:SendNotification({
                  text = _U('service_max') .. inServiceCount .. '/' .. maxInService,
                  type = "info",
                  layout = "centerleft",
                  queue = "info"
                })
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('wr-walikota:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('wr-walikota:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('wr-walikota:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('wr-walikota:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('wr-walikota:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('wr-walikota:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('wr-walikota:getFineList', function(fines)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('wr-walikota:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('wr-walikota:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('wr-walikota:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('wr-walikota:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('wr-walikota:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('wr-walikota:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('wr-walikota:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('wr-walikota:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('wr-walikota:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('wr-walikota:putStockItems', itemName, count)
            end
...
AddEventHandler('wr-walikota:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('wr-walikota:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('wr-walikota:hasEnteredEntityZone', function(entity)
...
AddEventHandler('wr-walikota:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('wr-walikota:handcuff')
AddEventHandler('wr-walikota:handcuff', function()
...
RegisterNetEvent('wr-walikota:drag')
AddEventHandler('wr-walikota:drag', function(cop)
...
RegisterNetEvent('wr-walikota:putInVehicle')
AddEventHandler('wr-walikota:putInVehicle', function()
...
RegisterNetEvent('wr-walikota:OutVehicle')
AddEventHandler('wr-walikota:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
      TriggerEvent('wr-walikota:publicTeleports', position)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'state' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('wr-walikota:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('wr-walikota:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('wr-walikota:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('wr-walikota:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['F5']) and PlayerData.job ~= nil and PlayerData.job.name == 'state' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'state_actions') and (GetGameTimer() - GUI.Time) > 150 then
